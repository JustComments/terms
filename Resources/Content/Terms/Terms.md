...
The following terms and conditions apply to all services and products of JustComments and include all content services and products available at or through JustComments. JustComments is operated by Oleksii Rudenko, a sole trader registered under the laws of Stuttgart, Germany. Theses terms and conditions shall apply to all users of the services.
...
2. The „Service“ refers to applications, software, products and services that are provided by JustComments.
3. „Website“ refers to our website at just-comments.com
...
5. „JustComments“, „We“, „Us“ refer to Oleksii Rudenko as well as, but not limited to, our affiliates, directors, subsidiaries, contractors, licensors, officers, agents, and employees.
...
JustComments may terminate parts of or the complete Service at any time.
...
Using our Service and accessing your Content may require an account. You are responsible for maintaining its security and confidentiality. JustComments will not be liable for the actions of a user’s account. Please [contact JustComments](mailto:alex@just-comments.com) if you suspect that your account has been compromised.
...
JustComments offers services through one-time purchases and subscriptions. The according pricing is available through the Service and may change over time and be different at the end of a payment term. All transactions are final and our services are paid in advance. By agreeing to these terms You give Us permission to charge the fees that you have authorized for JustComments to your provided payment method. All payment information are handled exclusively by our third party payment provider. We never store your credit card details.
...
You will not attempt to disrupt or tamper with JustComments’s servers in any way and most particularly in a way that could harm our website or the Service. Any security breach must be reported in a secure way directly to JustComments. We should be given an appropriate time to investigate the issue before it is disclosed publicly.
...
This Agreement constitutes the entire agreement between JustComments and You concerning the subject matter hereof, and it may only be modified by a written amendment signed by an authorised executive of JustComments, or by the posting of a revised version by JustComments.

Except to the extent of applicable law, if any, provides otherwise, this Agreement, any access to or use of our Services, shall be governed by the laws of Stuttgart Germany, excluding its conflict of law provisions, and the proper venue for any disputes arising out of or relating to any of the same will be the state and federal courts located in Stuttgart, Germany. The arbitration shall take place in Stuttgart, Germany, in the German language and the arbitral decision may be enforced in any court. The prevailing party in any action or proceeding to enforce this Agreement shall be entitled to costs and attorneys’ fees.
...
If you have any further questions about our Terms of Service, please [contact us](mailto:alex@just-comments.com).

---

## Attribution:

Parts of this Terms of Service document are adapted from [Colloq’s Terms of Service and Privacy Policy](https://github.com/colloq/terms), licensed under [Creative Commons Attribution-ShareAlike 4.0 International Public License](https://creativecommons.org/licenses/by-sa/4.0/).
The complete Terms of Service of JustComments are therefore licensed under the same [Creative Commons Attribution-ShareAlike 4.0 International Public License](https://creativecommons.org/licenses/by-sa/4.0/).
